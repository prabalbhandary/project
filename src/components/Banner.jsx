  ...
  return (
    <div className="relative">
      ...
      >
        <path
          fill="#6B21A8"
          d="M0,96L48,80C96,64,192,32,288,37.3C384,43,480,85,576,122.7C672,160,768,192,864,202.7C960,213,1056,203,1152,170.7C1248,139,1344,85,1392,58.7L1440,32V320H0Z"
        />
      </svg>
